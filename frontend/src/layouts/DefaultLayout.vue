  ...
  <div class="layout-container">
    ...
    <header class="dashboard-header">
      <div class="header-left">
        <div class="logo">
          <span class="material-symbols-outlined logo-icon" style="font-variation-settings: 'FILL' 1, 'wght' 400; color: var(--primary, #D4AF37);">travel_explore</span>
          <span class="logo-text">万古经纬</span>
        </div>
      </div>
...
const loadStats = async () => {
  try {
    ...
    stats.value = {
      ...
      sourcesCount: data.total_sectors?.toLocaleString() || '-',
