...
class BSENoticeMonitor:
    """北交所公告监控类"""

    def __init__(self):
        """初始化监控器"""
        self.fetcher = BSENoticeFetcher()
    ...
    async def fetch_yesterday_notices(self) -> List[dict]:
        ...
        print(f"Fetching BSE notices for {yesterday_str}...")
        ...
        for notice in notices:
            try:
                ...
                event_data = EventCreate(
                    ...
                    event_category=EventCategory.COMPANY_UPDATES,  # 北交所公告归类为公司动态
    ...
    async def run(self):
        """运行监控循环"""
        print("=" * 60)
        print("Starting BSE Notice Monitor...")
        print("=" * 60)
        print("Configuration:")
        print("  - Fetch: Previous day's all notices")
        print("  - Interval: 1 hour")
        print("  - Source: Beijing Stock Exchange")
        print("=" * 60)
        ...
        try:
            ...
            print("\n" + "=" * 60)
            print("Stopping BSE Notice Monitor...")
            print("=" * 60)
        except Exception as e:
            print(f"\nMonitor crashed: {e}")
            import traceback
